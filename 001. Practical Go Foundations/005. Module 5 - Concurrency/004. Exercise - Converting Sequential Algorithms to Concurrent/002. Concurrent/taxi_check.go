...
Note that the "error: ../taxi_files/taxi-06.csv.bz2 mismatch" when running the program is by design (for demonstrative purposes).
*/
package main
...
func main() {
	rootDir := "../taxi_files" // Change this to where you extracted taxi.tar.
	...
	// Fan out to process the files concurrently.
